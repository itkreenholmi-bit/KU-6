...
# NO CACHE on prepare_data - merging is cheap and avoids hashing issues
...
def main():
    ...
    # Load data – no spinner inside main, but we use a simple progress message
    ...
    # Sidebar – global metric selection
